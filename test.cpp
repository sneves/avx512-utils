...
#else
template<typename F>
static void check_function(F f, unsigned x)
{
...
int main()
{
    ...
    check_function(~_1, [](__m512i a, __m512i b, __m512i c) 
    { 
    ...
    check_function(_b ^ _c, [](__m512i a, __m512i b, __m512i c) 
    { 
        return _mm512_xor_epi64(b, c); 
    });

    check_function(_a&_b ^ _b&_c ^ _a&_c, [](__m512i a, __m512i b, __m512i c) 
    { 
        return _mm512_xor_epi64(_mm512_xor_epi64(_mm512_and_epi64(a, b), _mm512_and_epi64(a, c)), _mm512_and_epi64(b, c)); 
    });

    check_function((~_b | ~_c) & (~_a ^ ~_b ^ _c), [](__m512i a, __m512i b, __m512i c) 
    { 
        return _mm512_xor_epi64(_mm512_and_epi64(_mm512_and_epi64(a, b), c), _mm512_xor_epi64(_mm512_xor_epi64(a, b), c));
    });
#else
